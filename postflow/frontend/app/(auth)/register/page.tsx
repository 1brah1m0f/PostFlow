      ...
      <div className="hidden lg:block w-1/2 relative">
        ...
        <div className="absolute bottom-12 left-10 right-10">
          <p className="text-pf-cream text-xl font-medium leading-relaxed">
            "Cultivate your audience. Join thousands of creators organizing their workflow with calm precision."
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-pf-cream flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-1.5">
            <h1 className="text-3xl font-bold text-pf-brown tracking-tight">Create an account</h1>
            <p className="text-sm text-pf-brown/60">Start scheduling with clarity.</p>
          </div>

          {/* Form */}
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-pf-brown/60 uppercase tracking-wider">Full name</label>
              <input
                type="text"
            ...
            <div className="space-y-1.5">
              ...
              />
              <p className="text-xs text-pf-brown/40">Must be at least 8 characters.</p>
            </div>
          ...
          <p className="text-xs text-center text-pf-brown/50">
            ...
            <Link href="/login" className="font-semibold text-pf-rust hover:underline">
              Sign in
            </Link>
          </p>
        </div>
